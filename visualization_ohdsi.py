...
def create_page(can, header, fig, graph_image_name, graph_size):
    """
    Helper function of create_report_ohdsi. Draw page.
...
def create_completeness(can, pdf, odf, cdf, sdf, ddf, prdf):
    """
    Helper function of create_report_ohdsi. Run completeness.
...
def create_uniqueness(can, pdf, odf, cdf, sdf, ddf, prdf):
    """
    Helper function of create_report_ohdsi. Run uniqueness.
...
def create_warnings(can, pdf, odf, cdf, sdf, ddf, prdf):
    """
    Helper function of create_report_ohdsi. Run warnings.
...
def create_reports(can, pdf, odf, cdf, sdf, ddf, prdf):
    """
    Helper function of create_report_ohdsi. Run reports.
