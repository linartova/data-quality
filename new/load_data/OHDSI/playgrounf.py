...
from omop_conversion_classes import Patient, ObservationPeriod, ConditionOccurrence,\
    Specimen, DrugExposure, ProcedureOccurrence
...
def read_xml_and_parse():
    tree = ElementTree.parse('import_example.xml')
    root = tree.getroot()
